...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>入学时间：</td>
								<td> 
								<input placeholder="入学时间" id="entrytime" name="entrytime" class="laydate-icon form-control layer-date"/> </td>
								<td>&nbsp;&nbsp;</td>
								<td>代课老师：</td>
								<td>
	...
	<!-- 新增老师 -->
	<div class="modal fade" id="modal_tea_edit" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_tea" method="post" action="reserveTea.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>老师名：</td>
								<td><input type="text" id="name" name="name"
	...
	$(function () {
	    ...
	    var validator = $("#form_tea").validate({
    		submitHandler: function(form){
   		      $(form).ajaxSubmit({
   		    	dataType:"json",
   		    	success: function (data) {
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    		...
	    		$.ajax({
	    		    ...
	    		    success:function(res){
	    		    	...
	    		    	for (var i = 0; i < obj.length; i++) {
	    		    		...
	    		    		ex[i]={value: nums[i], name: tnames[i]}
	    	...
	    	$("#btn_tea").click(function(){
	    		$("#form_tea").resetForm();
	    		$('#modal_tea_edit').modal({backdrop: 'static', keyboard: false});
				$('#modal_tea_edit').modal('show');
	        });
