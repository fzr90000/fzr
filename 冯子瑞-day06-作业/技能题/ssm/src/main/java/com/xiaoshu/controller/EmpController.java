...
public class EmpController extends LogController{
	...
	public void reserveUser(HttpServletRequest request,eEmp emp,HttpServletResponse response,MultipartFile file) throws Exception, IOException{
		if (emp.getPic()==null) {
			String filename = file.getOriginalFilename();
			if (filename!=null) {
				String substring = filename.substring(filename.lastIndexOf("."));
				String string = UUID.randomUUID().toString()+substring;
				file.transferTo(new File("D:/photo/"+string));
				emp.setPic(string);
