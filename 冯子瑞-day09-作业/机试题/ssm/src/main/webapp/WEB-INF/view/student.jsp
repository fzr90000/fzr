...
<body class="gray-bg">
	...
	<!-- 导入课程-->
	<div class="modal fade" id="keheng" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_ke" method="post" action="adddept.htm" enctype="multipart/form-data">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>课程名：</td>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_ke_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	<!-- Daoru -->
	<div class="modal fade" id="imp" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_imp" method="post" action="imp.htm" enctype="multipart/form-data">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="imp_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	<div class="modal fade" id="bing" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" id="bingtu" style="width: 600px; height: 600px" >
				</div>
				<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
			</div>
	...
	$(function () {
	    ...
	    var validator = $("#form_ke").validate({
    		submitHandler: function(form){
   		      $(form).ajaxSubmit({
   		    	dataType:"json",
   		    	success: function (data) {
	    ...
	    $("#submit_form_ke_btn").click(function(){
	    	$("#form_ke").submit();
	    });
	});
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_adddept").click(function(){
	    		$('#keheng').modal({backdrop: 'static', keyboard: false});
				$('#keheng').modal('show');
	        });
	        //Daolu
	    	$("#btn_imp").click(function(){
	    		$('#imp').modal({backdrop: 'static', keyboard: false});
				$('#imp').modal('show');
	        });
	    	...
	    	$("#btn_bing").click(function(){
	    			...
	    			var myex=echarts.init(document.getElementById("bingtu"));
	    			var nums=new Array();
	    			...
	    			$.ajax({
	    			    ...
	    			    success:function(res){
	    			    	...
	    			    	for (var i = 0; i < obj.length; i++) {
	    			    		...
	    			    		ec[i]={value:obj[i].num,name:obj[i].tname}
