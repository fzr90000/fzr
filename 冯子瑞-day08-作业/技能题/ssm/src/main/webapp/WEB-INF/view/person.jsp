...
<body class="gray-bg">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>特点：</td>
								<td><input type="checkbox" id="expressTrait1" name="expressTrait" value="耐心"/>耐心
	...
	/* 	$('#createTime').val(new Date(getSelection.createTime).Format("yyyy-MM-dd HH:mm:ss")); */
		$('#expressTrait').attr("readOnly",true).val(getSelection.password);
		var sp=getSelection.expressTrait.split(",");
		for (var t = 0; t < sp.length; t++) {
			$("input[value="+sp[t]+"]").prop("checked",true);
