					...
					<form id="form_user" method="post" action="reserveUser.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<img alt="" src="" width="50px" height="50px" id="pics">
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>入学时间：</td>
	...
	<div class="modal fade" id="zhu" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div style="width:800px;height:200px;">
			<div class="modal-content">
				...
				<div  id="zhutu" style="width: 800px;height: 300px">
				</div>
				<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
			</div>
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            ...
	            },
	            {
	                ...
	                formatter:function(value,row,index){
	                	return "<img src='/photo/"+value+"' width='52px' height='50px'>";
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_zhu").click(function(){
	    		...
	    		var mych=echarts.init(document.getElementById("zhutu"));
	    			var nums=new Array();
	    			...
	    			$.ajax({
	    			    ...
	    			    success:function(res){
	    			    	var tb=$.parseJSON(res);
	    			    	for (var i = 0; i < tb.length; i++) {
								nums[i]=tb[i].num;
								teanames[i]=tb[i].teaname;
							}
	    			    	option = {
	    	    				    xAxis: {
	    	    				        type: 'category',
