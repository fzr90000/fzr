...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="date" name="strat" id="start">
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<input type="checkbox" name="sHobby" id="sHobby" value="羽毛球">羽毛球
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>生日：</td>
	...
	<div class="modal fade" id="zhu" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" id="zhutu" style="width: 500px;height: 600px">
	...
	<div class="modal fade" id="xian" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" id="xiantu" style="width: 500px;height: 600px">
	...
	<div class="modal fade" id="bing" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" id="bingtu" style="width: 500px;height: 600px">
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_zhu").click(function(){
	    		...
	    		var my=echarts.init(document.getElementById("zhutu"))
	    		var nums=new Array();
	    	...
	    	$("#btn_xian").click(function(){
	    		...
	    		var my=echarts.init(document.getElementById("xiantu"))
	    		var nums=new Array();
	    		var mnames=new Array();
	    		$.ajax({
	    		    url:"gettj.htm",
	...
	function initEditUser(getSelection){
		...
		var arr=getSelection.sHobby.split(",")
