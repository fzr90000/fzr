...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>学生爱好：</td>
								<td>
								<input type="checkbox" id="sdhobby1" name="sdhobby" value="篮球" aria-required="true" required/>篮球
								<input type="checkbox" id="sdhobby2" name="sdhobby" value="排球" aria-required="true" required/>排球
								<input type="checkbox" id="sdhobby3" name="sdhobby" value="羽毛球" aria-required="true" required/>羽毛球
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>学生生日：</td>
	...
	<div class="modal fade" id="zhu" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" id="zhutu" style="width: 500px;height: 400px">
				</div>
				<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
			</div>
	...
	function initEditUser(getSelection){
		...
		var arr=getSelection.sdhobby.split(",");
