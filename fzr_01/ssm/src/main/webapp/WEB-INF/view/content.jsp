					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>链接：</td>
								<td><input type="text" id="password" name="contenturl"
									class="form-control" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>图片路径：</td>
								<td><input type="text" id="username" name="picpath"
									class="form-control" aria-required="true" required/></td>
								<td>&nbsp;&nbsp;</td>
								<td>价格：</td>
							...
							<tr>
								<td>备注：</td>
								<td><input  id="txt_search_start" name="createtime" class="laydate-icon form-control layer-date"/></td>
							</tr>
						</table>
